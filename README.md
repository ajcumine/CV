...
Ansible, App Center, AWS, Azure, Babel, Buildkite, CircleCI, CSS, CSS-in-JS, Docker, DynamoDB, Elasticsearch, Enzyme, ES6, Flow, GitHub Actions, Google Cloud Platform, Gulp, Heroku, HTML, JavaScript, Jest, Kubernetes, Lodash, Mocha, MongoDB, Mori, Node, PactJS, Papertrail, PostgreSQL, Prettier, Puppeteer, Rails, Ramda, React, React Native, Redis, Redux, Rspec, Rubocop, Ruby, Sass, Serverless, Storybook, Teamcity, Terraform, Thin, Typescript, TSLint, Vagrant, Webpack, Yarn.

Agile development methodologies, Cross-functional teams, Data driven design/development, Kanban, Microservice architecture, Mobile first design/development, Monorepository architecture, North Star Metric, Objectives and Key Results, Scrum, Software as a Service.

## Work Experience

### [Second Nature](https://secondnature.io/), March 2021 - present.

React Native iOS and Android application focussing on behavioural change and education to aid weight loss. Supporting customer facing web application, internal operations applications, and supporting platforms.
...
#### PagoFx - Operations, July 2019 - March 2020.
